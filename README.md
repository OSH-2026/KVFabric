...
|:---------------------------:|:---------:|:-------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:-----------------:| ----------------------------------- |
|选题|2026-03-28|线下会议，交流选题想法，确定项目方向|周家润：基于eBPF的KV Cache性能剖析器在AIOS/vLLM中的简单实现与瓶颈分析；赵天翔：在loong arch架构开发板上编写可运行验证性操作系统；王允：用RUST语言改写一门简单的操作系统|决定采用在loong arch架构开发板上编写可运行验证性操作系统|[log](logs/2026-03-28.md)|
