...
本文档描述当前项目阶段：它位于已经归档的 vLLM bring-up 记录之后，也位于 `/home/qy-dream/OSH_Project/work` 中正式 benchmark 和论文方法复现之前。
...
- `experiments/`：当前阶段批量测试、在线测试、prefix reuse smoke、中等体量测试和日志摘要。
...
- `/home/qy-dream/OSH_Project/work` 中的正式 benchmark 矩阵：预计几十分钟到数小时。
