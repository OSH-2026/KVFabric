...
class PrometheusStatLogger(AggregateStatLoggerBase):
    ...
    def __init__(
        ...
        self.counter_prefix_cache_request_hits = create_metric_per_engine(
            counter_prefix_cache_request_hits, per_engine_labelvalues
        )
        ...
        if self.kv_cache_metrics_enabled:
            ...
            self.histogram_kv_block_access_count = create_metric_per_engine(
                histogram_kv_block_access_count, per_engine_labelvalues
            )
            ...
            self.histogram_kv_block_peak_ref_count = create_metric_per_engine(
                histogram_kv_block_peak_ref_count, per_engine_labelvalues
            )
            ...
            self.histogram_kv_block_cache_depth = create_metric_per_engine(
                histogram_kv_block_cache_depth, per_engine_labelvalues
            )
            ...
            self.histogram_kv_block_recompute_cost = create_metric_per_engine(
            ...
            self.histogram_kv_block_lookup_time = create_metric_per_engine(
                histogram_kv_block_lookup_time, per_engine_labelvalues
            )
            ...
            self.histogram_kv_block_access_count = {}
    ...
    def record(
        ...
        if scheduler_stats is not None:
            ...
            if (
                ...
                access_count_hist = self.histogram_kv_block_access_count[engine_idx]
                peak_ref_hist = self.histogram_kv_block_peak_ref_count[engine_idx]
                cache_depth_hist = self.histogram_kv_block_cache_depth[engine_idx]
            ...
            if self.kv_cache_metrics_enabled:
                ...
                if lifecycle_stats.metadata_update_time_seconds > 0:
