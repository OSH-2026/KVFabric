...
- Do not add custom runtime code before the vLLM baseline is clearly established.
- Prefer design notes, deployment records, and benchmark plans over premature implementation.
- Keep the long-term goal aligned with a C++-first, portable scheduler/runtime.
